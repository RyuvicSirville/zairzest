                ...
                <div class="cols-start-1 cols-end-2">
                    <div class="grid grid-rows-3 max-h-[800px]">
                        <div class=" py-[50px] px-[100px] row-start-1 row-end-3">
                            <div class="text-gray-100 font-sans text-[4vw]">Enter into Digital Playground with</div>

                            <img class="h-[2vw]" src={zaiza}></img>
                            <div class=" py-10 text-gray-100 font-sans text-[2vw]">
